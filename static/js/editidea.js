...
$(".idt-switch").click( function() {
	...
	$.ajax({
             ...
             data : {_wpnonce: nonce, title: $(".project-title").val(), status: "publish", content: `<?php $the_projectID = `+projectID+`; ?>`, template: "/wp-content/themes/MindEmpathy-wp/publishidea.php"},
