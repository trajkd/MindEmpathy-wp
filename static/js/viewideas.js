...
dynamodb.query(queryParams, function(err, data) {
	if (err) {
		...
		if (data.Items[0].YoutubeBG.S === "") {
			...
			$("#player0").attr("src", "https://www.youtube.com/embed/"+(data.Items[0].YoutubeBG.S).substring((data.Items[0].YoutubeBG.S).val().lastIndexOf('=') + 1)+"?autoplay=1&mute=1&controls=0&iv_load_policy=3&cc_load_policy=0modestbranding=1playsinline=1&rel=0&showinfo=0&playlist=o&enablejsapi=1&widgetid=5");
		}
